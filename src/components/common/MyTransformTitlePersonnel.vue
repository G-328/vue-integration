...
export default {
  ...
  methods: {
    ...
    // moveRight() {
    //   this.arrLeft.forEach((i,index) => {
    //     this.datasLeft = this.datasLeft.filter(item => {
    //       return item != i;
    //     });
    //     this.dataRight.push(i);
    //   });
    //   // this.datasRight=this.unique(this.dataRight,'userId');
    // },
    // moveLeft() {
    //   // this.arrRight.forEach((i,index) => {
    ...
    // // });
    //   // this.datasLeft=this.unique(this.dataLeft,'userId');
    // },
    moveUp() {
